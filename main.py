...
async def on_message(message):
    ...
    elif message.content.startswith("number one victory royale"):
        await message.channel.send("Yea fortnite we boutta get down!")
    
    elif message.content.startswith("what is your purpose tunetastic?"):
        await message.channel.send("To one day be able to play music in the Voice Channels...")
    
    elif message.content.startswith("ea sports"):
